  ...
  return (
    <>
      ...
      <Menu theme="light" mode="inline">
        <Menu.Item key="1">
          <NavLink to="/dashboardTransporteur" className='text-decoration-none'>
            <span
              className="icon"
              style={{
        ...
        <Menu.Item key="3">
          <NavLink to="/transporteur/calendrier" className='text-decoration-none'>
            <span
              className="icon"
              style={{
        ...
        <Menu.Item key="3">
          <NavLink to="/transporteur/profile" className='text-decoration-none'>
            <span
              className="icon"
              style={{
                background: page === "tables" ? color : "",
